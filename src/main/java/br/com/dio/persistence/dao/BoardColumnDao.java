...
public class BoardColumnDAO {
    ...
    public List<BoardColumnEntity> findByBoardId(final Long boardId) throws SQLException {
        ...
        try (var statement = connection.prepareStatement(sql)) {
            ...
            // Correção aqui: use o ResultSet retornado diretamente
...
// aqui é importante o findByName funcionar direitinho
                    entity.setBoardId(boardId); // 👈 Talvez você tenha esquecido de setar o boardId!
                    entities.add(entity);
                }
            }
        }
    ...
    public List<BoardColumnDTO> findByBoardIdWithDetails(final Long boardId) throws SQLException {
        ...
        var sql =
                ...
                SELECT bc.id,
                       ...
                       (SELECT COUNT(c.id)
                               FROM CARDS c
                              WHERE c.board_id = bc.id) cards_amount
    ...
    public Optional<BoardColumnEntity> findById(final Long boardId) throws SQLException{
        var sql =
                ...
                SELECT 
                    ...
                    c.id AS card_id,
                    c.titulo AS card_title,
                    c.description AS card_description
                FROM BOARDS_COLUMNS bc
                LEFT JOIN CARDS c ON c.board_id = bc.id
                WHERE bc.id = ?;
                """;
